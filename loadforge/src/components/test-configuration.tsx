    ...
    if (file) {
      ...
      reader.onload = (event) => {
        try {
          ...
          setUrls(config.urls.map((url: string, i: number) => ({ id: Date.now() + i, url })))
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-gray-600">Configure and run a new performance test</p>
      </div>
      ...
      <div className="space-y-6">
        <Card className="border-gray-200">
          <CardHeader>
            ...
            <CardDescription className="text-gray-600">Add the endpoints you want to test</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              <Button onClick={exportConfig} variant="outline" className="border-gray-300 bg-transparent">
        ...
        <Card className="border-gray-200">
          <CardHeader>
            ...
            <CardDescription className="text-gray-600">Define how load will ramp up during the test</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
              ...
              <Input
                ...
                className="border-gray-300"
              />
              <p className="mt-1 text-xs text-gray-600">Number of concurrent requests at each phase</p>
            </div>
